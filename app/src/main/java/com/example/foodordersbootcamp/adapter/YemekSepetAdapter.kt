...
import com.example.foodordersbootcamp.databinding.YemekSepetCardTasarimBinding
...
class YemekSepetAdapter(
    ...
    var sepetYemekListesi: List<YemekSepet>,
    var viewModel: YemekSepetFragmentViewModel,
    var yemekSepetBinding: FragmentYemekSepetBinding
        ...
        t.imageViewSilResim.setOnClickListener {
            ...
            snackbar.setAction("Evet") {
                ...
                val snackbar2 = Snackbar.make(
                    it,
                    "${sepetyemek.yemek_adi} başarıyla silindi...",
                    Snackbar.LENGTH_SHORT
                )
                snackbar2.view.setBackgroundResource(R.drawable.background_snackbar)
